...
function App() {
  ...
  return (
    <>
      ...
      <div className="zbody flex justify-center bg-[#171823] min-h-[100vh] pt-[50px]! bg-[url('/images/bg-desktop-dark.jpg')] bg-no-repeat bg-[length:100%_auto] max-xl:bg-[url('/images/bg-mobile-dark.jpg')]" style={darkLight ? { backgroundColor: "#FAFAFA", backgroundImage: "url('/images/bg-desktop-light.jpg')" } : null}>
